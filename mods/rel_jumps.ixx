...
export namespace foresight::mods {
    ...
    constexpr struct ignore_big_jumps_type {
      private:
      ...
      public:
        ...
        ignore_big_jumps_type(ignore_big_jumps_type const&) noexcept            = default;
        ignore_big_jumps_type(ignore_big_jumps_type&&) noexcept                 = default;
        ignore_big_jumps_type& operator=(ignore_big_jumps_type const&) noexcept = default;
        ignore_big_jumps_type& operator=(ignore_big_jumps_type&&) noexcept      = default;
        ~ignore_big_jumps_type() noexcept                                       = default;
