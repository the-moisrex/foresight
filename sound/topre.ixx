...
export namespace fs8 {
    ...
    /// Synthesizer for Topre electrostatic-capacitive (rubber dome) keystroke
    /// sounds.
    ///
    /// The signature soft thock: rubber-dome collapse over a capacitive
    /// spring, damped housing resonance, almost no metallic shimmer.  Pure
    /// synthesis through the shared click engine (`fs8::detail::render_click`)
    /// — no recorded attack samples.
    struct [[nodiscard]] topre_synth {
        constexpr topre_synth() noexcept = default;
