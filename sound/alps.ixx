...
export namespace fs8 {
    ...
    /// Synthesizer for Alps SKCM-class (Orange) keystroke sounds.
    ///
    /// Crisp leaf click: fast, sharp attack, hollow housing ping over a
    /// light bottom-out.  Pure synthesis through the shared click engine
    /// (`fs8::detail::render_click`) — no recorded attack samples.
    struct [[nodiscard]] alps_synth {
        constexpr alps_synth() noexcept = default;
