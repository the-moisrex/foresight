...
export module fs8.mods:typewriter;
...
export namespace fs8 {
    ...
    /// Synthesizer for manual-typewriter keystroke sounds.
    ///
    /// Typebar strike: instant sharp attack, loud metallic pings with very
    /// narrow modes, short tight ring, and a platen/carriage thump underneath.
    /// Pure synthesis through the shared click engine
    /// (`fs8::detail::render_click`) — no recorded attack samples.
    struct [[nodiscard]] typewriter_synth {
        constexpr typewriter_synth() noexcept = default;
