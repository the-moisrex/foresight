...
def generate_cxx():
    ...
    lines.append("")
    lines.append("using fs8::click_params;")
    lines.append("")
    lines.append("// clang-format off")
    lines.append("")
    lines.append("const std::array<click_params, 256> fs8::bucklespring_press_params = {{")
    lines.extend(generate_array_rows(is_press=True))
    lines.append("}};")
    lines.append("")
    lines.append("const std::array<click_params, 256> fs8::bucklespring_release_params = {{")
